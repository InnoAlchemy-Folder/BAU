...
const AdminInvolved: React.FC = () => {
  const initialData = {
    get_involved_header: { title: "", description: "", photo: null },
    Who_we_are: { title: "", description: "", photo: null },
    What_we_do: { title: "", description: "", photo: null },
    Join_Us_Today: { title: "", description: "", photo: null },
    get_involved_banner: { title: "", description: "", photo: null },
  };

  const [formData, setFormData] = useState<{
    get_involved_header: FormData;
    Who_we_are: FormData;
    What_we_do: FormData;
    Join_Us_Today: FormData;
    get_involved_banner: FormData;
  }>(initialData);

  const [checkboxes, setCheckboxes] = useState({
    get_involved_header: false,
    Who_we_are: false,
    What_we_do: false,
    Join_Us_Today: false,
    get_involved_banner: false,
  });
